...
import 'edital_verticalizado_assuntos_screen.dart';

class EditalVerticalizadoDisciplinaScreen extends StatefulWidget {
  final id;
  final type;
  final imageCategory;

  EditalVerticalizadoDisciplinaScreen(this.id, this.type, this.imageCategory);

  @override
  _EditalVerticalizadoDisciplinaScreenState createState() => _EditalVerticalizadoDisciplinaScreenState();
}

class _EditalVerticalizadoDisciplinaScreenState extends State<EditalVerticalizadoDisciplinaScreen> {
                              ...
                              onTap: (){
                                _categories[index]['children_count'] == 0
                                    ...
                                    new PageRouteBuilder(
                                      pageBuilder: (_, __, ___) => EditalVerticalizadoAssuntoScreen(
                                    ...
                                    new MaterialPageRoute(
                                        builder: (context) =>
                                            EditalVerticalizadoDisciplinaScreen(
                                              _categories[index]['id']
                                                  .toString(),
  ...
  */
  ...
  _getDados() async {
    ...
    try {
      ...
      var response = await dio.get("editais/verticalizado/${widget.id}",
