import 'questoes_filtros_screen.dart';
...
class QuestionDisciplinaScreen extends StatefulWidget {
  @override
  _QuestionDisciplinaScreenState createState() => _QuestionDisciplinaScreenState();
}

class _QuestionDisciplinaScreenState extends State<QuestionDisciplinaScreen> {
                                      ...
                                      Material(
                                        ...
                                        child: Center(
                                          child: Padding(
                                            ...
                                            child: RotatedBox(quarterTurns: 2,child: Icon(FontAwesomeIcons.reply,
                                                size: 25.0),)
                                          ),
                                        ),
                                      ),
